...
export type ProfileStackParamList = {
  ...
  Favoritos: undefined;
  MapaFromProfile:
    | { focus?: { id: string; latitude: number; longitude: number } }
    | undefined;
};
  ...
  return (
    ...
    >
      ...
      <Stack.Screen
        ...
        options={{ title: 'Tus productos' }}
      />
      <Stack.Screen
        name="Obtenidos"
        component={ObtenidosScreen}
        options={{ title: 'Productos obtenidos' }}
      />
      <Stack.Screen
        name="Favoritos"
